export default function Hero() {
  return <div class="flex items-center flex-col md:flex-row">
  <div class='flex flex-col gap-5 max-h-dvh h-120 sm:h-100 justify-end'>
    ...
    <div class='text-gray-500'>
      ...
      evaluate its language understanding, generation, and reasoning
      across diverse tasks, aiding researchers in optimizing it{' '}
      <span class='text-uchu-purple-5 font-bold'>for real-world use
      </span>.
    </div>
    <div class="flex items-center gap-2 flex-wrap justify-start">
      <a href="/chart" class="p-3 rounded-full bg-uchu-purple-5 hover:bg-uchu-purple-4 text-white font-bold">Open Chart Viewer</a>
      <a href="/chart" class="text-uchu-purple-5 hover:text-uchu-purple-4">or search models</a>
    </div>
  </div>
</div>
}