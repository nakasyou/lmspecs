    ...
    <div class="flex items-center justify-end md:items-start flex-col sm:flex-row-reverse gap-1">
      <div class="flex flex-col gap-2">
        <div class='font-bold text-2xl'>
          Can a <span class='text-uchu-purple-5'>Single Score</span> Define a Model’s Worth?
        </div>
      ...
      <div class="sm:min-w-50 h-40">
        <img src={imageUnifiedLight} alt="Unified benchmarks" class="w-full h-full block dark:hidden" />
        <img src={imageUnifiedDark} alt="Unified benchmarks" class="w-full h-full hidden dark:block" />
      </div>
    </div>
  )
}
