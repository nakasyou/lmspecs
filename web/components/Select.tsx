  ...
  return (
    <div ref={ref} class={'inline-block relative ' + (props.class)}>
      <div
        ...
        class='w-full border p-1 rounded-md border-gray-200 flex justify-between items-center cursor-pointer hover:bg-gray-50 hover:dark:bg-gray-700 transition-colors'
      >
        <div class="text-slate-700 dark:text-slate-200">{props.titles[getValue()]}</div>
        <div
            ...
            >
              {([id, title]) => (
                <div
                  ...
                  class='text-slate-700 dark:text-slate-200 transition-colors p-1 first:rounded-t-md last:rounded-b-md cursor-pointer hover:bg-uchu-gray-1 dark:hover:bg-uchu-gray-9'
                  onClick={() =>
